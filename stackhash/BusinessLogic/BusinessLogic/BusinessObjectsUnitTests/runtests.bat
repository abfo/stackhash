...
:starttest
set component=businessobjectsunittests
if not exist r:\stackhash\results\%1\%component%.xml goto runtest
del r:\stackhash\results\%1\%component%.xml 

:runtest
mstest /testcontainer:"r:\stackhash\businesslogic\businesslogic\%component%\bin\%1\%component%.dll" /resultsfile:"r:\stackhash\results\%1\%component%.xml"
