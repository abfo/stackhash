...
namespace StackHash.CommandLinePlugin
{
    ...
    /// </summary>
    public sealed class CommandLinePluginControl : MarshalByRefObject, IBugTrackerV1Control
    {
        #region Fields

        private static readonly string s_PlugInName = StackHash.CommandLinePlugin.Properties.Resources.Plugin_Name;
        private static readonly string s_PlugInDescription = StackHash.CommandLinePlugin.Properties.Resources.Plugin_Description;
        private static readonly Uri s_HelpUrl = new Uri("http://www.stackhash.com/Help/stackhash-command-line-plugin.aspx");
        ...
        private List<CommandLinePluginContext> m_ActiveContexts = new List<CommandLinePluginContext>();
        ...
        /// </summary>
        public CommandLinePluginControl()
        {
            ...
            // on XP systems.
            BugTrackerTrace.LogMessage(BugTrackerTraceSeverity.Information, s_PlugInName, "CommandLinePluginControl Interface created");
        }
