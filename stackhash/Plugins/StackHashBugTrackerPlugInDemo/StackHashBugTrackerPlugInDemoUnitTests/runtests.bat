...
set component=stackhashbugtrackerplugindemounittests
...
:runtest
mstest /testcontainer:"r:\stackhash\plugins\StackHashBugTrackerPlugInDemo\%component%\bin\%1\%component%.dll" /resultsfile:"r:\stackhash\results\%1\%component%.xml"
