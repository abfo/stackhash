...
namespace StackHash.EmailPlugin
{
    ...
    /// </summary>
    public sealed class EmailPluginControl : MarshalByRefObject, IBugTrackerV1Control
    {
        #region Fields

        private static readonly string s_PlugInName = StackHash.EmailPlugin.Properties.Resources.Plugin_Name;
        private static readonly string s_PlugInDescription = StackHash.EmailPlugin.Properties.Resources.Plugin_Description;
        private static readonly Uri s_HelpUrl = new Uri("http://www.stackhash.com/Help/stackhash-email-plugin.aspx");
        ...
        private List<EmailPluginContext> m_ActiveContexts = new List<EmailPluginContext>();
        ...
        // Note: default properties defined in Settings.cs
        ...
        public EmailPluginControl()
        {
            ...
            // on XP systems.
            BugTrackerTrace.LogMessage(BugTrackerTraceSeverity.Information, s_PlugInName, "EmailPluginControl Interface created");
        }
