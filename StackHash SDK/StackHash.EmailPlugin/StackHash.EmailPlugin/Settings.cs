...
namespace StackHash.EmailPlugin
{
    ...
    sealed class Settings : IDisposable
    {
        ...
        private const string SmtpPortDescrption = "SMTP Port:";
        ...
        public NameValueCollection ToNameValueCollection()
        {
            ...
            nameValueCollection[SmtpPortDescrption] = this.SmtpPort.ToString(CultureInfo.InvariantCulture);
        ...
        public static Settings FromNameValueCollection(NameValueCollection nameValueCollection)
        {
            ...
            if (!string.IsNullOrEmpty(nameValueCollection[SmtpPortDescrption]))
            {
                settings.SmtpPort = Convert.ToInt32(nameValueCollection[SmtpPortDescrption], CultureInfo.InvariantCulture);
            }
